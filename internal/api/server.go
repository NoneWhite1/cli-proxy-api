...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/codex-force-websockets", s.mgmt.GetCodexForceWebsockets)
		mgmt.PUT("/codex-force-websockets", s.mgmt.PutCodexForceWebsockets)
		mgmt.PATCH("/codex-force-websockets", s.mgmt.PutCodexForceWebsockets)
		...
		mgmt.POST("/auth-files/preheat", s.mgmt.PreheatCodexAuthFile)
		mgmt.POST("/auth-files/preheat/jobs", s.mgmt.StartPreheatJob)
		mgmt.GET("/auth-files/preheat/jobs/:job_id", s.mgmt.GetPreheatJob)
		mgmt.GET("/auth-files/preheat/auto", s.mgmt.GetPreheatAuto)
		mgmt.PATCH("/auth-files/preheat/auto", s.mgmt.PatchPreheatAuto)
